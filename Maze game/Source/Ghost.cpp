...
{
	// i spent 2 hours debugging this
...
void Ghost::update_target(unsigned char i_pacman_direction, const Position &i_ghost_0_position, const Position &i_pacman_position)
{
	...
	else
	{
		...
		{
			// this ghost AI is so complex i had to draw it on paper first
			switch (id)
			{
			case 0:
			{
			...
			case 2:
			{
				// professor said this is called "vector math" but i just copied it from stackoverflow
				target = i_pacman_position;
				switch (i_pacman_direction)
				{
				case 0:
			...
			case 3:
			{
				// this ghost is lazy and gives up if pacman is too far away
